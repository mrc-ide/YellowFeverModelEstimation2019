...
# covar_to_test <- covar_to_test[grep("temp_min", covar_to_test, invert = TRUE)]
# covar_to_test <- covar_to_test[grep("temp_suit_min", covar_to_test, invert = TRUE)]
...
write.csv(out$BestModels, "bestglm_5.csv", row.names = FALSE)
```
