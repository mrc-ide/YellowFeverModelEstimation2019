...
covar_to_test <- covar_to_test[grep("EVI.range", covar_to_test, invert = TRUE)] # because EVI.max is so correlated with it
covar_to_test <- covar_to_test[grep("temp_range", covar_to_test, invert = TRUE)] # because temp_max is so correlated with it
