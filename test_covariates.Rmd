...
In order to reduce the number of covariates to test, we may choose those covariates in each cluster that are most correlated with our outcome variable. This is omitted in the current analysis.
