...
glm_mcmc_out <- YFestimation::get_chains(paste0("GLM_MCMC_chain_20200128_bestglm_6_binaryalt_", 
...
model_form_whole = read.csv("bestglm_6.csv", stringsAsFactors = FALSE) %>% 
