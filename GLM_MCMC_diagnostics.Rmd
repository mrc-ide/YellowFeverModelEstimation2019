...
glm_mcmc_out=get_chains("GLM_MCMC_chain_20190808", burnin =1.4e6, thin = 1)
...
Est_beta =  apply(glm_mcmc_out[,1:64], 2, median)
...
filename = KsetupR::get_latest_file(path = Env_Table_path, pattern = "dat_6")
