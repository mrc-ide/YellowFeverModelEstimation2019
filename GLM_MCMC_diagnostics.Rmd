...
glm_mcmc_out=get_chains("GLM_MCMC_chain_20190821_6_all", burnin =3e4, thin = 1)
...
cols = viridis_pal(option = "magma")(ncol(glm_mcmc_out)-2)
par(mfrow = c(4,3))
...
```{r crosscor_glm,   fig.cap = "Crosscorrelation of all parameters.", fig.align='center', fig.pos = 'h', strip.white=F, fig.height = 10}
...
```{r glm_predict,  fig.cap = "\\label{fig:predict_glm}Prediction of glm. The scale indicates the probability of  YF report over the observation period.", fig.align='center', fig.pos = 'h', strip.white=F, fig.height = 10, fig.width=10}
...
#########################################################################################################
plot_glm_map2(shp0, shp1,  dat, Est_beta, x, colours = viridis_pal(option = "magma")(1000))
...
colours = viridis_pal(option = "magma")(1000)
### model ###
