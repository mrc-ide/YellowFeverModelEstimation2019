...
glm_mcmc_out=get_chains("GLM_MCMC_chain_20190814_4", burnin =1e4, thin = 1)
...
cols = viridis_pal(option = "magma")(12)
par(mfrow = c(3,4))
...
filename = KsetupR::get_latest_file(path = Env_Table_path, pattern = "dat_8")
...
x_wo_adm05 = x[, grep("predicted", colnames(x), invert = TRUE)]
Est_beta_wo_adm05 = Est_beta[grep("predicted", names(Est_beta), invert = TRUE)]
