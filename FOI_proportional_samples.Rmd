...
glm_mcmc_out <- YFestimation::get_chains(paste0("GLM_MCMC_chain_20191016_bestglm_1_", 1),
                          burnin =6e4, thin = 1)
...
coeff_of_var = sapply(1:ncol(foi_out), FUN = function(i) sd(foi_out[,i], na.rm = T)/
                        mean(foi_out[,i], na.rm = T)) *100
