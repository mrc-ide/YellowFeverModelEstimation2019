...
glm_mcmc_out <- YFestimation::get_chains("GLM_MCMC_chain_20191003_step_1_continentprior_wideprior",
                          burnin =1e5, thin = 1)
...
write.csv(foi_out, "FOI_samples_step_1_continentprior.csv", row.names = FALSE)
