...
glm_mcmc_out <- YFestimation::get_chains("GLM_MCMC_chain_20191001_step_1_wideprior_nocontinent",
                          burnin =1e5, thin = 1)
...
write.csv(foi_out, "FOI_samples_step_1_wideprior_nocontinent.csv", row.names = FALSE)
