...
glm_mcmc_out <- YFestimation::get_chains("GLM_MCMC_chain_20191007_step_1_continentprior",
                          burnin =7e4, thin = 1)
...
if(!exists("foi_out")){
  foi_out = read.csv( "FOI_samples_step_1_continentprior.csv", stringsAsFactors = FALSE)
} 
