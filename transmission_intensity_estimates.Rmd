...
knitr::opts_chunk$set(
  dev = "png",
  fig.path = paste0("new_imagesA_", params$model_variant, "/"),
  dpi = 300,
  warning = FALSE,
  message = FALSE
)
...
glm_mcmc_out <- YFestimation::get_chains(paste0("GLM_MCMC_chain_20200903_bestglm_A_", params$model_variant),
                          burnin =1e5, thin = 1)
...
if(params$foi_sample){
  ...
  write.csv(foi_out, paste0("new_FOI_samples_bestglm_A_", params$model_variant, ".csv"), row.names = FALSE)
}
```
