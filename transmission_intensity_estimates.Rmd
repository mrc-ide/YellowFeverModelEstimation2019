...
glm_mcmc_out <- YFestimation::get_chains(paste0("GLM_MCMC_chain_20200115_bestglm_3_", params$model_variant),
                          burnin =1e5, thin = 1)
...
if(params$foi_sample){
  ...
  write.csv(foi_out, paste0("FOI_samples_bestglm_3_", params$model_variant, ".csv"), row.names = FALSE)
}
```
