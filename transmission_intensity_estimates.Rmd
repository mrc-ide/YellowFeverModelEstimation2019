...
glm_mcmc_out <- YFestimation::get_chains("GLM_MCMC_chain_20190925_9",
                          burnin =5e4, thin = 1)
...
model_form_whole <- read.csv("Model_form9.csv", stringsAsFactors = FALSE)$x
...
write.csv(foi_out, "FOI_samples_9.csv", row.names = FALSE)
