...
glm_mcmc_out = get_chains("GLM_MCMC_chain_20190912_6_all_agg", 
                        burnin =4.5e5, thin = 1)
...
filename <- KsetupR::get_latest_file(path = Env_Table_path, pattern = "dat_11")
...
write.csv(foi_out, "FOI_samples_nb.csv", row.names = FALSE)
```
