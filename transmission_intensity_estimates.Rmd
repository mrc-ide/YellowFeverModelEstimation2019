...
glm_mcmc_out <- YFestimation::get_chains("GLM_MCMC_chain_20191015_step_2_noagg_groupprior2",
                          burnin =5e4, thin = 1)
...
write.csv(foi_out, "FOI_samples_step_2_noagg_grouprior2.csv", row.names = FALSE)
