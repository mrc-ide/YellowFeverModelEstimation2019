...
knitr::opts_chunk$set(
  dev = "png",
  fig.path = paste0("images6_", params$model_variant, "/"),
  dpi = 300,
  warning = FALSE,
  message = FALSE
)
...
glm_mcmc_out <- YFestimation::get_chains(paste0("GLM_MCMC_chain_20200128_bestglm_6_binaryalt_", params$model_variant),
                          burnin =6e4, thin = 1)
...
if(params$foi_sample){
  ...
  write.csv(foi_out, paste0("FOI_samples_bestglm_6_", params$model_variant, ".csv"), row.names = FALSE)
}
```
