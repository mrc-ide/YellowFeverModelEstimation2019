...
if(!exists("glm_mcmc_out")){
  glm_mcmc_out <- YFestimation::get_chains("GLM_MCMC_chain_20190927_c_noadm05",
                                           burnin =5e4, thin = 1)
...
write.csv(foi_out, "FOI_samples_c_noadm05.csv", row.names = FALSE)
