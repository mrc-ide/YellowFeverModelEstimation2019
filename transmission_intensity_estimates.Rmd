...
glm_mcmc_out <- YFestimation::get_chains("GLM_MCMC_chain_20191014_step_2_dtp3_posprior",
                          burnin =1e4, thin = 1)
...
write.csv(foi_out, "FOI_samples_step_2_dtp3_posprior.csv", row.names = FALSE)

```


```{r coeff_of_var, eval = F}

if(!exists("foi_out")){
  foi_out = read.csv( "FOI_samples_step_2.csv", stringsAsFactors = FALSE)
} 
