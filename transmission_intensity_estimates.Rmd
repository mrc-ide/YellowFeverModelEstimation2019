...
glm_mcmc_out <- YFestimation::get_chains("GLM_MCMC_chain_20191007_step_1_continentprior_lowriskpriorchange",
                          burnin =7e4, thin = 1)
...
write.csv(foi_out, "FOI_samples_step_1_continentprior_lowriskpriorchange.csv", row.names = FALSE)
...
if(!exists("foi_out")){
  foi_out = read.csv( "FOI_samples_step_1_continentprior_lowriskpriorchange.csv", stringsAsFactors = FALSE)
} 
