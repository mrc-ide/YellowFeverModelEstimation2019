...
fois = read.csv( "FOI_samples_step_1_continentprior.csv", stringsAsFactors = FALSE)
...
```{r compare_cases, fig.height=5, fig.width=10}

ggplot(combined, aes(colour = Countries, x = Year)) + 
  geom_line(aes(y = Cases)) +
  geom_line(aes(y = round(severe_infections/reporting_propn)), linetype = "dashed") +
  facet_wrap(~Countries, scales = "free_y")
```

```{r compare_deaths, fig.height=5, fig.width=10}
